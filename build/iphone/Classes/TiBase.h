...
enum {
	UIMyTunesRSSNativeItemNone = -1, 
	UIMyTunesRSSNativeItemSpinner = -2,
	UIMyTunesRSSNativeItemProgressBar = -3,
	
	UIMyTunesRSSNativeItemSlider = -4,
	UIMyTunesRSSNativeItemSwitch = -5,
	UIMyTunesRSSNativeItemMultiButton = -6,
	UIMyTunesRSSNativeItemSegmented = -7,
	
	UIMyTunesRSSNativeItemTextView = -8,
	UIMyTunesRSSNativeItemTextField = -9,
	UIMyTunesRSSNativeItemSearchBar = -10,
	
	UIMyTunesRSSNativeItemPicker = -11,
	UIMyTunesRSSNativeItemDatePicker = -12,
	
	UIMyTunesRSSNativeItemInfoLight = -13,
	UIMyTunesRSSNativeItemInfoDark = -14,
	
	UIMyTunesRSSNativeItemDisclosure = -15,
	
	UIMyTunesRSSNativeItemContactAdd = -16
};
