...
//@interface MyTunesRSSObject : NSObject
//@end

@interface MyTunesRSSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MyTunesRSSObject class]])
		{
			for (NSString *key in [[(MyTunesRSSObject*)o modules] allKeys])
			{
