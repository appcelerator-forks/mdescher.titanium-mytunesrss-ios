...
{
	//JGH: this method was modified by MyTunesRSS to support delegates of the same type that aren't a UIProgressView
					...
					else
					{
						...
						if ([cookies count] > 0) 
						{
							...
							for (cookie in cookies) 
							{
								...
								// Maybe here could a MyTunesRSS-Api-Call made it configurable what cookie values are
