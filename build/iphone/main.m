...
NSString * const TI_APPLICATION_VERSION = @"1.0.6";
NSString * const TI_APPLICATION_DESCRIPTION = @"MyTunesRSS iOS client";
NSString * const TI_APPLICATION_COPYRIGHT = @"2011 by Codewave Software Michael Descher";
NSString * const TI_APPLICATION_GUID = @"5d7f6b5d-f3ff-4590-9c82-ee0e74ee4a65";
